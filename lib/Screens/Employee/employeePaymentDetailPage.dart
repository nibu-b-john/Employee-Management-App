...
class EmployeePaymentDetailPage extends StatefulWidget {
  Map<String, dynamic> contractDetails;
  String email;
  EmployeePaymentDetailPage(
      {super.key, required this.contractDetails, required this.email});

  @override
  State<EmployeePaymentDetailPage> createState() =>
      _EmployeePaymentDetailPageState();
}

class _EmployeePaymentDetailPageState extends State<EmployeePaymentDetailPage> {
