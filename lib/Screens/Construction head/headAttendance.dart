...
class HeadAttendance extends StatefulWidget {
  String code;
  String email;
  HeadAttendance({super.key, required this.code, required this.email});

  @override
  State<HeadAttendance> createState() => _HeadAttendanceState();
}

class _HeadAttendanceState extends State<HeadAttendance> {
